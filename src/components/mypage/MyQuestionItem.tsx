...
// const MyQuestionItem = () => {
//   const [myConsults, setMyConsults] = useState<UserConsultType[]>([]);
//   const [answerStatus, setAnswerStatus] = useState<JSX.Element | string>("");
//   useEffect(() => {
//     const fetchMyConsults = async () => {
//       try {
//         const consults = (await getMyConsultData()) ?? []; // 유저가 맞으면 유저 상담글 정보를 다 갖고와

//         for (const consult of consults) {
//           const consultAnswer = await checkConsultAnswer(consult.consult_id);
//           console.log("consultAnswer ====> ", consultAnswer);
//         }

//         setMyConsults(consults as UserConsultType[]);
//       } catch (error) {
//         if (error instanceof Error) console.error(error.message);
//       }
//     };
